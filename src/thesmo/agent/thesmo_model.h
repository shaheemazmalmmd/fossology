...
#define TH_DECLARED_MAX 32 /**< identifiers a notice may declare */
/** how far past a declaration a word that withdraws it is the same sentence */
#define TH_DECLARED_REACH 120
...
#define TH_TEXT_GAP 200      /**< a run of a licence's wording: no gap wider than this ... */
#define TH_TEXT_RUN 800      /**< ... at least this long ... */
#define TH_TEXT_DENSITY 0.2  /**< ... and covered by its phrases to this share */
#define TH_TEXT_RUNS_MAX 16  /**< runs of one licence's text read per file */
#define TH_EXPLAINS_COVER 0.9  /**< how much of a claim's wording an explaining licence must cover ... */
#define TH_EXPLAINS_BEYOND 0.25 /**< ... and how much of its own must lie beyond it */
#define TH_SUBSUMED_REACH 400 /**< how far a licence's own wording may sit from the text it is said to explain */
#define TH_VERSION_REACH 80 /**< a version stated this far after a licence name belongs to it; covers the FSF notice */
...
typedef struct
{
  ...
  /* Required phrases: text a license has and its near
  ...
  char ***conStmt; /**< per class, the copyright statements above its text, or NULL */
  ...
  /** the declaration is read by where it stands, ahead of the license's text */
  int declAhead[TH_DECLARED_MAX];
  /** a word that withdraws the declaration where it follows within reach */
  char *declUnless[TH_DECLARED_MAX];
  ...
  regex_t famMember[TH_FAMILY_MAX]; /**< which names belong to the family, signature or none */
  int famMemberOk[TH_FAMILY_MAX];
  ...
  char **clauseLead; /**< per class, the grant words that run into that list, or NULL */
  int nFamily;
...
#define TH_VARIANT_SHARE 0.5f /**< of a variant's own phrases, to displace */
  ...
  float thGate, thMargin, thSuffix, thException;
...
/** share of a license's own phrases the file must carry to be the license
    rather than a notice of it */
#define TH_TEXT_SHARE 0.5f
